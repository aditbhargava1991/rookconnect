            ...
            if (isset($_GET['checklistid']) && !empty($_GET['checklistid'])) {
                ...
                while($row = mysqli_fetch_array( $result )) {
                    ...
                    if($security['edit'] > 0) {
                        ...
                        echo '<span style="display:inline-block; text-align:center; width:12.5%;"" onclick="flag_item(this); return false;"><img class="no-toggle" src="'.WEBSITE_URL.'/img/icons/ROOK-flag-icon.png" style="height:1.5em;" onclick="return false;" title="Flag This!></span>';
                        echo '<span style="display:inline-block; text-align:center; width:12.5%;" onclick="send_alert(this); return false;"><img class="no-toggle" src="'.WEBSITE_URL.'/img/icons/ROOK-alert-icon.png" style="height:1.5em;" onclick="return false;" title="Activate Alerts &amp; Get Notified"></span>';
                        echo '<span style="display:inline-block; text-align:center; width:12.5%;" onclick="send_email(this); return false;"><img class="no-toggle" src="'.WEBSITE_URL.'/img/icons/ROOK-email-icon.png" style="height:1.5em;" onclick="return false;" title="Send Email"></span>';
                        echo '<span style="display:inline-block; text-align:center; width:12.5%;" onclick="send_reminder(this); return false;"><img class="no-toggle" src="'.WEBSITE_URL.'/img/icons/ROOK-reminder-icon.png" style="height:1.5em;" onclick="return false;" title="Schedule Reminder"></span>';
                        echo '<span style="display:inline-block; text-align:center; width:12.5%;" onclick="attach_file(this); return false;"><img class="no-toggle" src="'.WEBSITE_URL.'/img/icons/ROOK-attachment-icon.png" style="height:1.5em;" onclick="return false;" title="Attach File"></span>';
                        echo '<span style="display:inline-block; text-align:center; width:12.5%;" onclick="send_reply(this); return false;"><img class="no-toggle" src="'.WEBSITE_URL.'/img/icons/ROOK-reply-icon.png" style="height:1.5em;" onclick="return false;" title="Add Note"></span>';
                        echo '<span style="display:inline-block; text-align:center; width:12.5%;" onclick="add_time(this); return false;"><img class="no-toggle" src="'.WEBSITE_URL.'/img/icons/ROOK-timer-icon.png" style="height:1.5em;" onclick="return false;" title="Add Time"></span>';
                        echo '<span style="display:inline-block; text-align:center; width:12.5%;" onclick="archive(this); return false;"><img class="no-toggle" src="'.WEBSITE_URL.'/img/icons/trash-icon-red.png" style="height:1.5em;" onclick="return false;" title="Archive"></span>';
                    }
                    echo '</span>';
