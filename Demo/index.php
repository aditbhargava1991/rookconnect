...
<div class="container">
    ...
    <div class="row hide_on_iframe">
			...
			if(stripos(','.$role.',',',super,') !== false) {
				echo '
					<div class="pull-left tab">
						...
						<a href="index.php?config_differences"><button type="button" class="btn brand-btn mobile-block mobile-100 ' . $active_tab_config . '">Live vs Demo Configurations</button></a>
					</div>';
		...
		<?php if (empty($_GET)) {
            header('location: index.php?config_differences');
			/*if(stripos(','.$role.',',',super,') === false) {
