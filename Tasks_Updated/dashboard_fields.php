    ...
    <div class="row">
        <label for="site_name" class="col-sm-3" style="<?= $style_strikethrough ?>">Staff:</label>
                <div class="col-sm-8" style="<?= $style_strikethrough ?>">
                    <select style="<?= $style_strikethrough ?>" multiple onchange="mark_task_staff(this);" data-placeholder="Select User" name="task_userid" data-table="tasklist" data-field="contactid" class="chosen-select-deselect form-control" id="staff_<?php echo $item['tasklistid']; ?>">
