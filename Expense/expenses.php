			...
			<div class="tile-sidebar standard-collapsible hide-titles-mob double-gap-top"  style="overflow-y:auto;">
				<ul>
					<?php if($_GET['tab'] == 'settings'){ ?>
						<a href="" onclick="$('.setting-fields>div:visible').hide(); $('.category_div').show(); $('.active.blue').removeClass('active blue'); $(this).find('li').addClass('active blue'); $('#settingTitle').html($(this).text()); return false;"><li class="active blue">Categories</li></a>
						<a href="" onclick="$('.setting-fields>div:visible').hide(); $('.heading_div').show(); $('.active.blue').removeClass('active blue'); $(this).find('li').addClass('active blue');$('#settingTitle').html($(this).text()); return false;"><li class="">Headings</li></a>
						<a href="" onclick="$('.setting-fields>div:visible').hide(); $('.manage_levels').show(); $('.active.blue').removeClass('active blue'); $(this).find('li').addClass('active blue');$('#settingTitle').html($(this).text()); return false;"><li class="">Level of Approval</li></a>
						<a href="" onclick="$('.setting-fields>div:visible').hide(); $('.expense_defaults_div').show(); $('.active.blue').removeClass('active blue'); $(this).find('li').addClass('active blue');$('#settingTitle').html($(this).text()); return false;"><li class="">Expense Default Fields</li></a>
						<a href="" onclick="$('.setting-fields>div:visible').hide(); $('.expense_fields_div').show(); $('.active.blue').removeClass('active blue'); $(this).find('li').addClass('active blue');$('#settingTitle').html($(this).text()); return false;"><li class="">Expense Fields</li></a>
						<a href="" onclick="$('.setting-fields>div:visible').hide(); $('.email_reminders_div').show(); $('.active.blue').removeClass('active blue'); $(this).find('li').addClass('active blue');$('#settingTitle').html($(this).text()); return false;"><li class="">Email Reminders</li></a>
						<a href="" onclick="$('.setting-fields>div:visible').hide(); $('.exchange_rates_div').show(); $('.active.blue').removeClass('active blue'); $(this).find('li').addClass('active blue');$('#settingTitle').html($(this).text()); return false;"><li class="">Exchange Rates</li></a>
						<a href="" onclick="$('.setting-fields>div:visible').hide(); $('.team_fields_div').show(); $('.active.blue').removeClass('active blue'); $(this).find('li').addClass('active blue');$('#settingTitle').html($(this).text()); return false;"><li class="">Team Fields</li></a>
						<a href="" onclick="$('.setting-fields>div:visible').hide(); $('.tax_defaults_div').show(); $('.active.blue').removeClass('active blue'); $(this).find('li').addClass('active blue');$('#settingTitle').html($(this).text()); return false;"><li class="">Tax Defaults</li></a>
						<a href="" onclick="$('.setting-fields>div:visible').hide(); $('.style_div').show(); $('.active.blue').removeClass('active blue'); $(this).find('li').addClass('active blue');$('#settingTitle').html($(this).text()); return false;"><li class="">Expense Styling</li></a>
						<a href="" onclick="$('.setting-fields>div:visible').hide(); $('.pdf_div').show(); $('.active.blue').removeClass('active blue'); $(this).find('li').addClass('active blue');$('#settingTitle').html($(this).text()); return false;"><li class="">PDF Settings</li></a>
					<?php } else{?>
						<div>
