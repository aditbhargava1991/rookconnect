...
<div class="form-group">
	...
	<div class="col-sm-8">
		...
		<label class="form-checkbox"><input type="checkbox" name="quick_action_icons[]" <?= in_array('flag',$quick_action_icons) ? 'checked' : '' ?> value="flag"> <img class="inline-img" src="../img/icons/color-wheel.png"> Highlight</label>
		...
		<label class="form-checkbox"><input type="checkbox" name="quick_action_icons[]" <?= in_array('scrum_sync',$quick_action_icons) ? 'checked' : '' ?> value="scrum_sync"> <img class="inline-img" src="../img/icons/ROOK-sync-icon.png"> Sync to Scrum Board</label>
