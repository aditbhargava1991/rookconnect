...
function privilegesConfig(sel) {
	...
	$.ajax({    //create an ajax request to load_page.php
		type: "GET",
		url: "../ajax_all.php?fill=privileges_config_staff&name="+name+"&level="+level+"&value="+final_value+"&uncheck_staff="+uncheck_staff+"&check_staff="+check_staff,
...
function changeLevel(sel) {
	var stage = sel.value;
	window.location = 'security.php?tab=privileges_by_staff&level='+stage;
}
function go_to_dashboard(target) {
	window.location.href = '?tab=privileges_by_staff&dashboard_id='+target;
}
</script>
...
<div class="row hide_on_iframe">
	...
	$on_security = get_security_levels_staff($dbc);
	$level_url = '';
	if(!empty($_GET['level'])) {
	...
	<div class="form-group">
		<label for="travel_task" class="col-sm-4 control-label">Select the Staff you wish to set tile access privileges to:</label>
		<div class="col-sm-8">
	...
	//$privileges = get_privileges_staff($dbc, $tile);
	?>
	...
	<table class='table table-bordered table-striped'>
		...
		<?php if(strpos($section_display,',software_settings,') !== FALSE): ?>
			...
			<tr data-dashboard='<?= (in_array('archiveddata', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('archiveddata', get_privileges_staff($dbc, 'archiveddata',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('customer_support', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('customer_support', get_privileges_staff($dbc, 'customer_support',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('ffmsupport', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('ffmsupport', get_privileges_staff($dbc, 'ffmsupport',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('passwords', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('passwords', get_privileges_staff($dbc, 'passwords',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('profile', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('profile', get_privileges_staff($dbc, 'profile',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('security', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('security', get_privileges_staff($dbc, 'security',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('software_config', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('software_config', get_privileges_staff($dbc, 'software_config',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
		<?php endif; ?>
		<?php if(strpos($section_display,',human_resources,') !== FALSE): ?>
			...
			<tr data-dashboard='<?= (in_array('certificate', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('certificate', get_privileges_staff($dbc, 'certificate',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('emp_handbook', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('emp_handbook', get_privileges_staff($dbc, 'emp_handbook',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			<?php if(strpos($on_security, ',employee_handbook,') !== FALSE) { ?>
			<tr data-dashboard='<?= (in_array('employee_handbook', $dashboard_list) ? 'current' : '') ?>'>
				<td data-title="Comment">Employee Handbook</td>
				<?php echo security_tile_config_function('employee_handbook', get_privileges_staff($dbc, 'employee_handbook',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('gao', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('gao', get_privileges_staff($dbc, 'gao',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('how_to_checklist', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('how_to_checklist', get_privileges_staff($dbc, 'how_to_checklist',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('how_to_guide', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('how_to_guide', get_privileges_staff($dbc, 'how_to_guide',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			<?php if(strpos($on_security, ',hr,') !== FALSE) { ?>
			<tr data-dashboard='<?= (in_array('hr', $dashboard_list) ? 'current' : '') ?>'>
				<td data-title="Comment">HR</td>
				<?php echo security_tile_config_function('hr', get_privileges_staff($dbc, 'hr',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('manual', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('manual', get_privileges_staff($dbc, 'manual',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('ops_manual', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('ops_manual', get_privileges_staff($dbc, 'ops_manual',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('orientation', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('orientation', get_privileges_staff($dbc, 'orientation',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('preformance_review', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('preformance_review', get_privileges_staff($dbc, 'preformance_review',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('policies', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('policies', get_privileges_staff($dbc, 'policies',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('policy_procedure', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('policy_procedure', get_privileges_staff($dbc, 'policy_procedure',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('safety_manual', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('safety_manual', get_privileges_staff($dbc, 'safety_manual',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('software_guide', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('software_guide', get_privileges_staff($dbc, 'software_guide',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('staff', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function_detailed('staff', get_privileges_staff($dbc, 'staff',$level), 1, $level_url, 0, 1, 1, 0, 1); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('training_quiz', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('training_quiz', get_privileges_staff($dbc, 'training_quiz',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
		...
		<?php if(strpos($section_display,',profiles,') !== FALSE): ?>
			...
			<tr data-dashboard='<?= (in_array('client_info', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('client_info', get_privileges_staff($dbc, 'client_info',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('contacts', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('contacts', get_privileges_staff($dbc, 'contacts',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('contacts_inbox', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('contacts_inbox', get_privileges_staff($dbc, 'contacts_inbox',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('contacts3', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('contacts3', get_privileges_staff($dbc, 'contacts3',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('contacts_rolodex', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('contacts_rolodex', get_privileges_staff($dbc, 'contacts_rolodex',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('fund_development', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('fund_development', get_privileges_staff($dbc, 'fund_development',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('members', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('members', get_privileges_staff($dbc, 'members',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('therapist', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('therapist', get_privileges_staff($dbc, 'therapist',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
		<?php endif; ?>
		...
		<?php if(strpos($section_display,',accounting,') !== FALSE): ?>
			...
			<tr data-dashboard='<?= (in_array('accounts_receivables', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('accounts_receivables', get_privileges_staff($dbc, 'accounts_receivables',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('budget', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('budget', get_privileges_staff($dbc, 'budget',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('expense', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('expense', get_privileges_staff($dbc, 'expense',$level), 1, $level_url, 0, 1); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('goals_compensation', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('goals_compensation', get_privileges_staff($dbc, 'goals_compensation',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('payables', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('payables', get_privileges_staff($dbc, 'payables',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('payroll', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('payroll', get_privileges_staff($dbc, 'payroll',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('profit_loss', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('profit_loss', get_privileges_staff($dbc, 'profit_loss',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('billing', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('billing', get_privileges_staff($dbc, 'billing',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('purchase_order', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('purchase_order', get_privileges_staff($dbc, 'purchase_order',$level), 1, $level_url, 0, 1); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('report', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('report', get_privileges_staff($dbc, 'report',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('vpl', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('vpl', get_privileges_staff($dbc, 'vpl',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
		<?php endif; ?>
		<?php if(strpos($section_display,',time_tracking,') !== FALSE): ?>
			...
			<tr data-dashboard='<?= (in_array('daysheet', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('daysheet', get_privileges_staff($dbc, 'daysheet',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('punch_card', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('punch_card', get_privileges_staff($dbc, 'punch_card',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('timesheet', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('timesheet', get_privileges_staff($dbc, 'timesheet',$level), 1, $level_url, 0, 1); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('time_tracking', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('time_tracking', get_privileges_staff($dbc, 'time_tracking',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
		<?php endif; ?>
		...
		<?php if(strpos($section_display,',inventory_management,') !== FALSE): ?>
			...
			<tr data-dashboard='<?= (in_array('assets', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('assets', get_privileges_staff($dbc, 'assets',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('inventory', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('inventory', get_privileges_staff($dbc, 'inventory',$level), 1, $level_url, 0, 0, 0, 1); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('material', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('material', get_privileges_staff($dbc, 'material',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('vendors', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('vendors', get_privileges_staff($dbc, 'vendors',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
		<?php endif; ?>
		...
		<?php if(strpos($section_display,',equipment,') !== FALSE): ?>
			...
			<tr data-dashboard='<?= (in_array('equipment', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('equipment', get_privileges_staff($dbc, 'equipment',$level), 1, $level_url, 1, 1); ?>
			</tr>
			<?php } ?>
		<?php endif; ?>
		<?php if(strpos($section_display,',collaborative_workflow,') !== FALSE): ?>
			...
			<tr data-dashboard='<?= (in_array('agenda_meeting', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('agenda_meeting', get_privileges_staff($dbc, 'agenda_meeting',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('appointment_calendar', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('appointment_calendar', get_privileges_staff($dbc, 'appointment_calendar',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('booking', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('booking', get_privileges_staff($dbc, 'booking',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('calendar_rook', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('calendar_rook', get_privileges_staff($dbc, 'calendar_rook',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('checklist', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('checklist', get_privileges_staff($dbc, 'checklist',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('interactive_calendar', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('interactive_calendar', get_privileges_staff($dbc, 'interactive_calendar',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('newsboard', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('newsboard', get_privileges_staff($dbc, 'newsboard',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('tasks', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('tasks', get_privileges_staff($dbc, 'tasks',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('tasks_updated', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('tasks_updated', get_privileges_staff($dbc, 'tasks_updated',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
            -->
			...
			<tr data-dashboard='<?= (in_array('optimize', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('optimize', get_privileges_staff($dbc, 'optimize',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
		<?php endif; ?>
		<?php if(strpos($section_display,',digital_forms,') !== FALSE): ?>
			...
			<tr data-dashboard='<?= (in_array('contracts', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('contracts', get_privileges_staff($dbc, 'contracts',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('daily_log_notes', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('daily_log_notes', get_privileges_staff($dbc, 'daily_log_notes',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			foreach($documents_all_tiles as $documents_all_tile) {
				if(strpos($on_security, ',documents_all,') !== FALSE && $documents_all_tile != '') { ?>
					<tr data-dashboard='<?= (in_array('documents_all#*#'.$documents_all_tile, $dashboard_list) ? 'current' : '') ?>'>
						...
						<?php echo security_tile_config_function('documents_all_'.config_safe_str($documents_all_tile), get_privileges_staff($dbc, 'documents_all_'.config_safe_str($documents_all_tile), $level), 0, $level_url); ?>
					</tr>
				<?php }
			} ?>
			...
			<tr data-dashboard='<?= (in_array('exercise_library', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('exercise_library', get_privileges_staff($dbc, 'exercise_library',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('form_builder', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('form_builder', get_privileges_staff($dbc, 'form_builder',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('charts', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('charts', get_privileges_staff($dbc, 'charts',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('medication', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('medication', get_privileges_staff($dbc, 'medication',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('routine', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('routine', get_privileges_staff($dbc, 'routine',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('treatment_charts', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('treatment_charts', get_privileges_staff($dbc, 'treatment_charts',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
		<?php endif; ?>
		<?php if(strpos($section_display,',estimates,') !== FALSE): ?>
			...
			<tr data-dashboard='<?= (in_array('cost_estimate', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('cost_estimate', get_privileges_staff($dbc, 'cost_estimate',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('estimate', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('estimate', get_privileges_staff($dbc, 'estimate',$level), 0, $level_url, 0, 1); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('field_ticket_estimates', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('field_ticket_estimates', get_privileges_staff($dbc, 'field_ticket_estimates',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('quote', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('quote', get_privileges_staff($dbc, 'quote',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
		<?php endif; ?>
		<?php if(strpos($section_display,',sales,') !== FALSE): ?>
			...
			<tr data-dashboard='<?= (in_array('calllog', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('calllog', get_privileges_staff($dbc, 'calllog',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('drop_off_analysis', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('drop_off_analysis', get_privileges_staff($dbc, 'drop_off_analysis',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('infogathering', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('infogathering', get_privileges_staff($dbc, 'infogathering',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('sales', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('sales', get_privileges_staff($dbc, 'sales',$level), 1, $level_url, 0, 1); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('sales_order', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('sales_order', get_privileges_staff($dbc, 'sales_order',$level), 1, $level_url, 0, 1); ?>
			</tr>
			<?php } ?>
		<?php endif; ?>
		...
		<?php if(strpos($section_display,',project_management,') !== FALSE): ?>
			...
			<tr data-dashboard='<?= (in_array('addendum', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('addendum', get_privileges_staff($dbc, 'addendum',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('addition', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('addition', get_privileges_staff($dbc, 'addition',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('assembly', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('assembly', get_privileges_staff($dbc, 'assembly',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('business_development', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('business_development', get_privileges_staff($dbc, 'business_development',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('client_projects', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('client_projects', get_privileges_staff($dbc, 'client_projects',$level), 1, $level_url, 1, 1); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('communication_schedule', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('communication_schedule', get_privileges_staff($dbc, 'communication_schedule',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('email_communication', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('email_communication', get_privileges_staff($dbc, 'email_communication',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('field_job', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('field_job', get_privileges_staff($dbc, 'field_job',$level), 1, $level_url, 1, 1); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('gantt_chart', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('gantt_chart', get_privileges_staff($dbc, 'gantt_chart',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('injury', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('injury', get_privileges_staff($dbc, 'injury',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('internal', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('internal', get_privileges_staff($dbc, 'internal',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
            ...
            <tr data-dashboard='<?//= (in_array('jobs', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php //echo security_tile_config_function('jobs', get_privileges_staff($dbc, 'jobs',$level), 1, $level_url, 1, 1); ?>
			</tr>
            -->
			<?php //} ?>
			...
			<tr data-dashboard='<?= (in_array('manufacturing', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('manufacturing', get_privileges_staff($dbc, 'manufacturing',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('marketing', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('marketing', get_privileges_staff($dbc, 'marketing',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('phone_communication', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('phone_communication', get_privileges_staff($dbc, 'phone_communication',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('process_development', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('process_development', get_privileges_staff($dbc, 'process_development',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('products', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('products', get_privileges_staff($dbc, 'products',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('project', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('project', get_privileges_staff($dbc, 'project',$level), 1, $level_url, 0, 1, 0, 1); ?>
			</tr>
			<?php } ?>
			...
			foreach($project_types as $project_type) {
				if(strpos($on_security, ',project,') !== FALSE) { ?>
					<tr data-dashboard='<?= (in_array('project#*#'.$project_type, $dashboard_list) ? 'current' : '') ?>'>
						...
						<?php echo security_tile_config_function('project_type_'.config_safe_str($project_type), get_privileges_staff($dbc, 'project_type_'.config_safe_str($project_type), $level), 0, $level_url, 0, 1); ?>
					</tr>
				<?php }
			} ?>
			...
			<tr data-dashboard='<?= (in_array('project_workflow', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('project_workflow', get_privileges_staff($dbc, 'project_workflow',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			<?php if(strpos($on_security, ',properties,') !== FALSE) { ?>
			<tr>
				<td data-title="Properties">Properties</td>
				<?php echo security_tile_config_function('properties', get_privileges_staff($dbc, 'properties',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			<?php if(strpos($on_security, ',rd,') !== FALSE) { ?>
			<tr data-dashboard='<?= (in_array('archiveddata', $dashboard_list) ? 'current' : '') ?>'>
				<td data-title="Comment">R&D</td>
				<?php echo security_tile_config_function('rd', get_privileges_staff($dbc, 'rd',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('scrum', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('scrum', get_privileges_staff($dbc, 'scrum',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('services', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('services', get_privileges_staff($dbc, 'services',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('shop_work_orders', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('shop_work_orders', get_privileges_staff($dbc, 'shop_work_orders',$level), 1, $level_url, 0, 1); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('site_work_orders', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('site_work_orders', get_privileges_staff($dbc, 'site_work_orders',$level), 1, $level_url, 0, 1); ?>
			</tr>
			<?php } ?>
			<?php if(strpos($on_security, ',sred,') !== FALSE) { ?>
			<tr data-dashboard='<?= (in_array('sred', $dashboard_list) ? 'current' : '') ?>'>
				<td data-title="Comment">SR&ED</td>
				<?php echo security_tile_config_function('sred', get_privileges_staff($dbc, 'sred',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('ticket', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('ticket', get_privileges_staff($dbc, 'ticket',$level), 1, $level_url, 1, 1, 0, 1); ?>
			</tr>
			<?php } ?>
			...
			foreach($ticket_type_tiles as $ticket_type) {
				if(strpos($on_security, ',ticket,') !== FALSE) { ?>
					<tr data-dashboard='<?= (in_array('ticket#*#'.$ticket_type, $dashboard_list) ? 'current' : '') ?>'>
						...
						<?php echo security_tile_config_function('ticket_type_'.config_safe_str($ticket_type), get_privileges_staff($dbc, 'ticket_type_'.config_safe_str($ticket_type), $level), 0, $level_url, 1); ?>
					</tr>
				<?php }
			} ?>
            ...
            while($ticket_group_tile = $ticket_group_tiles->fetch_assoc()['value']) {
                ...
                <tr data-dashboard='<?= (in_array('ticket#*#'.$ticket_type, $dashboard_list) ? 'current' : '') ?>'>
                    ...
                    <?php echo security_tile_config_function('ticket_tile_'.config_safe_str($ticket_group_tile[0]), get_privileges_staff($dbc, 'ticket_tile_'.config_safe_str($ticket_group_tile[0]), $level), 0, $level_url, 1); ?>
                </tr>
            <?php } ?>
		<?php endif; ?>
		<?php if(strpos($section_display,',safety,') !== FALSE): ?>
			...
			<tr data-dashboard='<?= (in_array('driving_log', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('driving_log', get_privileges_staff($dbc, 'driving_log',$level), 0, $level_url, 0, 1); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('incident_report', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('incident_report', get_privileges_staff($dbc, 'incident_report',$level), 0, $level_url, 1, 1); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('match', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('match', get_privileges_staff($dbc, 'match',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('safety', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('safety', get_privileges_staff($dbc, 'safety',$level), 1, $level_url, 1, 0); ?>
			</tr>
			<?php } ?>
		<?php endif; ?>
		...
		<?php if(strpos($section_display,',point_of_sale,') !== FALSE): ?>
			...
			<tr data-dashboard='<?= (in_array('check_in', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('check_in', get_privileges_staff($dbc, 'check_in',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('check_out', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('check_out', get_privileges_staff($dbc, 'check_out',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('custom', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('custom', get_privileges_staff($dbc, 'custom',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('invoicing', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('invoicing', get_privileges_staff($dbc, 'invoicing',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('labour', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('labour', get_privileges_staff($dbc, 'labour',$level), 0, $level_url, 0, 0, 1); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('package', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('package', get_privileges_staff($dbc, 'package',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('posadvanced', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('posadvanced', get_privileges_staff($dbc, 'posadvanced',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('promotion', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('promotion', get_privileges_staff($dbc, 'promotion',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('rate_card', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('rate_card', get_privileges_staff($dbc, 'rate_card',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('service_queue', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('service_queue', get_privileges_staff($dbc, 'service_queue',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
		<?php endif; ?>
		...
		<?php if(strpos($section_display,',crm,') !== FALSE): ?>
			...
			<tr data-dashboard='<?= (in_array('confirmation', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('confirmation', get_privileges_staff($dbc, 'confirmation',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('confirm', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('confirm', get_privileges_staff($dbc, 'confirm',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			<?php if(strpos($on_security, ',crm,') !== FALSE) { ?>
			<tr data-dashboard='<?= (in_array('crm', $dashboard_list) ? 'current' : '') ?>'>
				<td data-title="Comment">CRM</td>
				<?php echo security_tile_config_function('crm', get_privileges_staff($dbc, 'crm',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('reactivation', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('reactivation', get_privileges_staff($dbc, 'reactivation',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('helpdesk', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('helpdesk', get_privileges_staff($dbc, 'helpdesk',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('website', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('website', get_privileges_staff($dbc, 'website',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
			...
			<tr data-dashboard='<?= (in_array('treatment', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('treatment', get_privileges_staff($dbc, 'treatment',$level), 0, $level_url); ?>
			</tr>
			<?php } ?>
		<?php endif; ?>
		...
		<?php if(strpos($section_display,',communication,') !== FALSE): ?>
			...
			<tr data-dashboard='<?= (in_array('non_verbal_communication', $dashboard_list) ? 'current' : '') ?>'>
				...
				<?php echo security_tile_config_function('non_verbal_communication', get_privileges_staff($dbc, 'non_verbal_communication',$level), 1, $level_url); ?>
			</tr>
			<?php } ?>
		<?php endif; ?>
	</table>
