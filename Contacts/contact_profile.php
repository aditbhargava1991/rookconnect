...
<div class="col-sm-12">
	...
	<div class="col-sm-6">
		<ul class="chained-list col-sm-6 small">
			...
			<?php if(in_array_any(['First Name','Last Name','Profile First Name','Profile Last Name'], $id_card_fields) && $contact['first_name'].$contact['last_name'] != '') { ?><li><img src="../img/person.PNG" class="dashboard-profile-icon" title="Full Name"><?= decryptIt($contact['first_name']).' '.decryptIt($contact['last_name']) ?></li><?php } ?>
			...
			<?php if(in_array_any(['Home Phone','Profile Home Phone'], $id_card_fields) && $contact['home_phone'] != '') { ?><li><a href="tel:<?= decryptIt($contact['home_phone']) ?>"><img src="../img/home_phone.PNG" class="dashboard-profile-icon" title="Home Phone"><?= decryptIt($contact['home_phone']) ?></a></li><?php } ?>
			<?php if(in_array_any(['Office Phone','Profile Office Phone'], $id_card_fields) && $contact['office_phone'] != '') { ?><li><a href="tel:<?= decryptIt($contact['office_phone']) ?>"><img src="../img/office_phone.PNG" class="dashboard-profile-icon" title="Office Phone"><?= decryptIt($contact['office_phone']) ?></a></li><?php } ?>
			<?php if(in_array_any(['Cell Phone','Profile Cell Phone'], $id_card_fields) && $contact['cell_phone'] != '') { ?><li><a href="tel:<?= decryptIt($contact['cell_phone']) ?>"><img src="../img/cell_phone.PNG" class="dashboard-profile-icon" title="Cell Phone"><?= decryptIt($contact['cell_phone']) ?></a></li><?php } ?>
			<?php if(in_array_any(['Email Address','Profile Email Address'], $id_card_fields) && $contact['email_address'] != '') { ?><li><a href="mailto:<?= decryptIt($contact['email_address']) ?>"><img src="../img/email.PNG" class="dashboard-profile-icon" title="Email Address"><?= decryptIt($contact['email_address']) ?></a></li><?php } ?>
			<?php if(in_array_any(['Second Email Address'], $id_card_fields) && $contact['second_email_address'] != '') { ?><li><a href="mailto:<?= decryptIt($contact['second_email_address']) ?>"><img src="../img/email.PNG" class="dashboard-profile-icon" title="Second Email Address"><?= decryptIt($contact['second_email_address']) ?></a></li><?php } ?>
			<?php if(in_array_any(['Company Email Address','Profile Company Email Address'], $id_card_fields) && $contact['office_email'] != '') { ?><li><a href="mailto:<?= decryptIt($contact['office_email']) ?>"><img src="../img/email.PNG" class="dashboard-profile-icon" title="Company Email Address"><?= decryptIt($contact['office_email']) ?></a></li><?php } ?>
			<?php if(in_array_any(['Start Date'], $id_card_fields) && $contact['start_date'] != '' && $contact['start_date'] != '0000-00-00') { ?><li><img src="../img/calendar.png" class="dashboard-profile-icon" title="Start Date"><?= $contact['start_date'] ?>
            ...
            <?php } ?>
			<?php if(in_array_any(['Contract End Date'], $id_card_fields) && $contact['contract_end_date'] != '' && $contact['contract_end_date'] != '0000-00-00') { ?><li><img src="../img/calendar.png" class="dashboard-profile-icon" title="Contract End Date"><?= $contact['contract_end_date'] ?></li>
            <?php } ?>
	...
	<div class="col-sm-6">
		<ul class="chained-list col-sm-6 small">
			<?php if(in_array_any(['Business','Program Business'], $id_card_fields) && $contact['businessid'] > 0) { ?><li><img src="../img/business.PNG" class="dashboard-profile-icon" title="Business"><?= get_client($dbc, $contact['businessid']) ?></li><?php } ?>
			<?php if(in_array_any(['Name'], $id_card_fields) && $contact['name'] != '') { ?><li><img src="../img/business.PNG" class="dashboard-profile-icon" title="Business Name"><?= decryptIt($contact['name']) ?></li><?php } ?>
			<?php if(in_array_any(['Location','Profile Location'], $id_card_fields) && $contact['con_location'] != '') { ?><li><img src="../img/address.PNG" class="dashboard-profile-icon" title="Location"><?= ($contact['con_location']) ?></li><?php } ?>
			...
			<?php if(in_array_any(['Guardians First Name'], $id_card_fields) && $contact['guardians_first_name'] != '') { ?>
				...
				<?php } ?>
			<?php } ?>
			<?php if(in_array_any(['LinkedIn','Profile LinkedIn'], $id_card_fields) && $contact['linkedin'] != '') { ?><li><a href="<?= $contact['linkedin'] ?>"><img src="../img/icons/social/linkedin.png" class="dashboard-social-icon" title="LinkedIn" /> LinkedIn</a></li><?php } ?>
			<?php if(in_array_any(['Facebook','Profile Facebook'], $id_card_fields) && $contact['facebook'] != '') { ?><li><a href="<?= $contact['facebook'] ?>"><img src="../img/icons/social/facebook.png" class="dashboard-social-icon" title="Facebook" /> Facebook</a></li><?php } ?>
			<?php if(in_array_any(['Twitter','Profile Twitter'], $id_card_fields) && $contact['twitter'] != '') { ?><li><a href="<?= $contact['twitter'] ?>"><img src="../img/icons/social/twitter.png" class="dashboard-social-icon" title="Twitter" /> Twitter</a></li><?php } ?>
			<?php if(in_array_any(['Google+','Profile Google+'], $id_card_fields) && $contact['google_plus'] != '') { ?><li><a href="<?= $contact['google_plus'] ?>"><img src="../img/icons/social/google+.png" class="dashboard-social-icon" title="Google+" /> Google+</a></li><?php } ?>
			<?php if(in_array_any(['Instagram','Profile Instagram'], $id_card_fields) && $contact['instagram'] != '') { ?><li><a href="<?= $contact['instagram'] ?>"><img src="../img/icons/social/instagram.png" class="dashboard-social-icon" title="Instagram" /> Instagram</a></li><?php } ?>
			<?php if(in_array_any(['Pinterest','Profile Pinterest'], $id_card_fields) && $contact['pinterest'] != '') { ?><li><a href="<?= $contact['pinterest'] ?>"><img src="../img/icons/social/pinterest.png" class="dashboard-social-icon" title="Pinterest" /> Pinterest</a></li><?php } ?>
			<?php if(in_array_any(['YouTube','Profile YouTube'], $id_card_fields) && $contact['youtube'] != '') { ?><li><a href="<?= $contact['youtube'] ?>"><img src="../img/icons/social/youtube.png" class="dashboard-social-icon" title="Youtube" /> YouTube</a></li><?php } ?>
			<?php if(in_array_any(['Blog','Profile Blog'], $id_card_fields) && $contact['blog'] != '') { ?><li><a href="<?= $contact['blog'] ?>"><img src="../img/icons/social/rss.png" class="dashboard-social-icon" title="Blog" /> Blog</a></li><?php } ?>
