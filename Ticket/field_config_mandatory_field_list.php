				...
				<div class="col-sm-8">
					...
					<div class="block-group">
						...
						<?php foreach ($selected_field_order as $selected_field_field) { ?>
								<label class="form-checkbox sort_order_field"><input type="checkbox" <?= in_array("PI Business", $all_config) ? 'checked disabled' : (in_array("PI Business", $value_config) ? "checked" : '') ?> value="<?php echo $selected_field_field; ?>" name="tickets[]">
