    ...
    <div class="row">
        ...
        if(in_array('next_ticket',$ticket_next_step_timesheet)) {
            ...
            if($ticket->num_rows > 0) {
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12" align="center"><span class="dashboard link" style="width: calc(100% - 45px);"><a href="../Ticket/index.php?<?= empty($_GET['tile_name']) ? '' : 'tile_name='.$_GET['tile_name'].'&' ?>edit=<?= $ticket['ticketid'] ?>&action_mode=<?= $_GET['action_mode'] ?>"><?= get_ticket_label($dbc, $ticket) ?></a></span></div>
            <?php }
        }
