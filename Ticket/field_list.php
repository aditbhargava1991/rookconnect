...
$accordion_list = [
	...
	'Medication' => [],
	'Ticket Details' => ['Help Desk','Service Category','Service Type','Service Heading','Service Quantity','Service Total Time','Service Direct Time','Service Indirect Time','Service Track Total Time','Service Track Direct Time','Service Track Indirect Time','Service # of Rooms','Service Rate Card','Service Estimated Hours','Service Fuel Charge','Service Preferred Staff','Service Total Price','Service Total Estimated Hours','Details Heading','Service Description','Details Where','Details Tile','Details Tab','Details Who','Details Why','Details What','Details Position','Details Checklist'],
	...
	'Charts' => [],
	'Safety' => [],
	'Timer' => ['Time Tracking Block','Day Tracking Block','Time Tracking Estimate Complete','Time Tracking Estimate QA','Time Tracking Time Allotted','Time Tracking Current Time','Time Tracking Timer','Time Tracking Timer Manual'],
	...
	'Delivery' => ['Assigned Equipment','Delivery Stops','Delivery Stops Order','Delivery Stops Volume','Delivery Pickup Equipment Category','Delivery Pickup Equipment Make','Delivery Pickup Equipment Model','Delivery Pickup Equipment','Delivery Pickup','Delivery Pickup Address','Delivery Pickup Address Google','Delivery Pickup Coordinates','Delivery Pickup Client','Delivery Pickup Customer','Delivery Pickup Phone','Delivery Pickup Phone2','Delivery Pickup Type','Delivery Pickup Volume','Delivery Pickup Cube','Delivery Pickup ETA','Delivery Pickup Customer Est Time','Delivery Pickup Estimate','Delivery Pickup Date','Delivery Pickup Order','Delivery Pickup Timeframe','Delivery Pickup Arrival','Delivery Pickup Departure','Delivery Pickup Description','Delivery Pickup Upload','Delivery Pickup Service List','Delivery Pickup Default Services','Delivery Pickup Warehouse Only','Delivery Pickup Populate Warehouse Address','Delivery Pickup Status','Delivery Pickup Populate Google Link','Delivery Pickup Notes','Delivery Pickup Dropoff Map','Delivery Calendar History','Delivery Completed Check','Delivery Warehouse Hours of Operation'],
	'Delivery Summary' => ['Delivery Summary Stop','Delivery Summary Client','Delivery Summary Address','Delivery Summary Services','Delivery Summary Status'],
	...
	'Customer Notes' => ['Customer Stop Status','Customer Contacted','Customer Driver Notes','Customer Property Photo','Customer Reset Details','Customer Property Damage','Customer Product Damage','Customer Product Damage Package','Customer Rate','Customer Delivery Rate','Customer Recommend','Customer Recommend Likely','Customer Add Details','Customer Sign','Customer Complete','Customer Slider','Customer Sign Off Complete Status','Customer Complete Exits Ticket'],
	'Custom Notes' => [],
	...
	'Attached Purchase Orders' => ['PO Name','PO 3rd Party','PO Invoice','PO Price','PO Mark Up','PO Total'],
	'Delivery Summary' => ['Delivery Summary Stop','Delivery Summary Client','Delivery Summary Address','Delivery Summary Services','Delivery Summary Status'],
	'Delivery' => ['Assigned Equipment','Delivery Stops','Delivery Stops Order','Delivery Stops Volume','Delivery Pickup Equipment Category','Delivery Pickup Equipment Make','Delivery Pickup Equipment Model','Delivery Pickup Equipment','Delivery Pickup','Delivery Pickup Address','Delivery Pickup Address Google','Delivery Pickup Coordinates','Delivery Pickup Client','Delivery Pickup Customer','Delivery Pickup Phone','Delivery Pickup Phone2','Delivery Pickup Type','Delivery Pickup Volume','Delivery Pickup Cube','Delivery Pickup ETA','Delivery Pickup Customer Est Time','Delivery Pickup Estimate','Delivery Pickup Date','Delivery Pickup Order','Delivery Pickup Timeframe','Delivery Pickup Arrival','Delivery Pickup Departure','Delivery Pickup Description','Delivery Pickup Upload','Delivery Pickup Service List','Delivery Pickup Default Services','Delivery Pickup Warehouse Only','Delivery Pickup Populate Warehouse Address','Delivery Pickup Status','Delivery Pickup Populate Google Link','Delivery Pickup Notes','Delivery Pickup Dropoff Map','Delivery Calendar History','Delivery Completed Check'],
	'Delivery Summary' => ['Delivery Summary Stop','Delivery Summary Client','Delivery Summary Address','Delivery Summary Services','Delivery Summary Status'],
	'Transport' => ['Transport Origin Contact','Transport Origin Name','Transport Origin','Transport Origin Country','Transport Origin Save Contact','Transport Origin Link','Transport Origin Warehouse','Transport Origin Arrival','Transport Origin Departure','Transport Destination Contact','Transport Destination Name','Transport Destination','Transport Destination Country','Transport Destination Save Contact','Transport Destination Link','Transport Destination Warehouse','Transport Destination Arrival','Transport Destination Departure','Transport Carrier','Transport Type','Transport Number','Transport Billed','Transport Container','Transport Manifest','Transport Ship Date','Transport Arrive Date','Transport Warehouse'],
	'Reading' => ['Readings CO','Readings O2','Readings LEL','Readings H2S','Readings Bump','Readings Arrival','Readings Departure'],
	'Tank Reading' => ['Tank Readings Tank #','Tank Readings Opening','Tank Readings Closing','Tank Readings Watercut','Tank Readings Oil'],
...
$accordion_list = [
	...
	'Other List' => ['Other Type','Other Quantity','Other Volume','Other Rate'],
	'Inventory' => ['Inventory Basic Inline','Inventory Basic Category','Inventory Basic Part','Inventory Basic Inventory','Inventory Basic Price','Inventory Basic Quantity','Inventory Basic Total','Inventory Basic Piece Type','Inventory Basic PO Line','Inventory Basic PO Line Sort','Inventory Basic Vendor','Inventory Basic Weight','Inventory Basic Units','Inventory Basic Dimensions','Inventory Basic Dimension Units','Inventory Basic Used','Inventory Basic Received','Inventory Basic Discrepancy','Inventory Basic Back Order','Inventory Basic Location','Inventory Basic Billing'],
	'Inventory General' => ['Inventory General Piece Count Type','Inventory General All Copy','Inventory General Piece Copy','Inventory General Piece','Inventory General Piece Type','Inventory General PO Number','Inventory General PO Number Dropdown','Inventory General PO Item','Inventory General PO Line Item','Inventory General PO Dropdown','Inventory General PO Dropdown Multiple','Inventory General PO Line Read','Inventory General PO Line Sort','Inventory General Piece Dim Weight','Inventory General Weight','Inventory General Units','Inventory General Weight Convert KG to LB','Inventory General Dimensions','Inventory General Dimension Units','Inventory General Shipment Count Weight','Inventory General Site','Inventory General Complete','Inventory General Total Count Weight','Inventory General Notes','Inventory General Detail','Inventory General Detail by Pallet','Inventory General Total Summary','Inventory General Manual Add Pieces','Inventory General Manual Remove Pieces','Inventory General Pallet Default Locked','Customer Complete Exits Ticket'],
	'Inventory Detail' => ['Inventory Detail Category','Inventory Detail Unique','Inventory Detail Quantity','Inventory Detail Site','Inventory Detail Piece Type','Inventory Detail Customer Order','Inventory Detail PO Num','Inventory Detail PO Line','Inventory Detail PO Dropdown','Inventory Detail PO Read','Inventory Detail PO Sort','Inventory Detail Vendor','Inventory Detail Weight','Inventory Detail Units','Inventory Detail Net Weight','Inventory Detail Net Units','Inventory Detail Gross Weight','Inventory Detail Gross Units','Inventory Detail Dimensions','Inventory Detail Dimension Units','Inventory Detail Used','Inventory Detail Received','Inventory Detail Discrepancy','Inventory Detail Discrepancy Yes No','Inventory Detail Back Order','Inventory Detail Location','Inventory Detail Manual Add'],
	'Inventory Return' => ['Inventory Return Same','Inventory Return Item','Inventory Return Details','Inventory Return ATA'],
	'Miscellaneous' => ['Miscellaneous Inline','Miscellaneous Name','Miscellaneous Price','Miscellaneous Quantity','Miscellaneous Total','Miscellaneous Billing'],
	'Purchase Orders' => [],
	'Attached Purchase Orders' => ['PO Name','PO 3rd Party','PO Invoice','PO Price','PO Mark Up','PO Total'],
	'Delivery Summary' => ['Delivery Summary Stop','Delivery Summary Client','Delivery Summary Address','Delivery Summary Services','Delivery Summary Status'],
	'Delivery' => ['Assigned Equipment','Delivery Stops','Delivery Stops Order','Delivery Stops Volume','Delivery Pickup Equipment Category','Delivery Pickup Equipment Make','Delivery Pickup Equipment Model','Delivery Pickup Equipment','Delivery Pickup','Delivery Pickup Address','Delivery Pickup Address Google','Delivery Pickup Coordinates','Delivery Pickup Client','Delivery Pickup Customer','Delivery Pickup Phone','Delivery Pickup Phone2','Delivery Pickup Type','Delivery Pickup Volume','Delivery Pickup Cube','Delivery Pickup ETA','Delivery Pickup Customer Est Time','Delivery Pickup Estimate','Delivery Pickup Date','Delivery Pickup Order','Delivery Pickup Timeframe','Delivery Pickup Arrival','Delivery Pickup Departure','Delivery Pickup Description','Delivery Pickup Upload','Delivery Pickup Service List','Delivery Pickup Default Services','Delivery Pickup Warehouse Only','Delivery Pickup Populate Warehouse Address','Delivery Pickup Status','Delivery Pickup Populate Google Link','Delivery Pickup Notes','Delivery Pickup Dropoff Map','Delivery Calendar History'],
	'Delivery Summary' => ['Delivery Summary Stop','Delivery Summary Client','Delivery Summary Address','Delivery Summary Services','Delivery Summary Status'],
	'Transport' => ['Transport Origin Contact','Transport Origin Name','Transport Origin','Transport Origin Country','Transport Origin Save Contact','Transport Origin Link','Transport Origin Warehouse','Transport Origin Arrival','Transport Origin Departure','Transport Destination Contact','Transport Destination Name','Transport Destination','Transport Destination Country','Transport Destination Save Contact','Transport Destination Link','Transport Destination Warehouse','Transport Destination Arrival','Transport Destination Departure','Transport Carrier','Transport Type','Transport Number','Transport Billed','Transport Container','Transport Manifest','Transport Ship Date','Transport Arrive Date','Transport Warehouse'],
	'Reading' => ['Readings CO','Readings O2','Readings LEL','Readings H2S','Readings Bump','Readings Arrival','Readings Departure'],
	'Tank Reading' => ['Tank Readings Tank #','Tank Readings Opening','Tank Readings Closing','Tank Readings Watercut','Tank Readings Oil'],
...
$action_mode_ignore_fields = ['TEMPLATE Work Ticket','Email Creator','Hide New Ticketid','Send Emails','Tag Notes','Additional','Export Ticket Log','Send Archive Email','Ticket Edit Cutoff','Quick Reminder Button','Business Set Delivery','Force All Caps','Ticket Tasks Add Button','Ticket Tasks Auto Check In','Ticket Tasks Auto Load New','Ticket Tasks Projects','Ticket Tasks Ticket Type','Ticket Tasks Groups','Task Extra Billing','Extra Billing Create New','Heading Blank','Heading Business Invoice','Heading Bus Invoice Date','Heading Project Invoice Date','Heading Business Date','Heading Contact Date','Heading Business','Heading Contact','Heading Date','Heading Milestone Date','Heading Assigned','Services','Service Inline','Service Multiple','Notes Limit','Complete Sign & Force Complete','Complete Default Session User','Service Group Cat Type All Services','Service Group Cat Type All Services Combine Checklist','Service Inline','Service Multiple','Service Staff Checklist Group Cat Type','Service Staff Checklist Extra Billing','Service Staff Checklist Another Room','Service Staff Checklist Another Room Copy Values','Service Extra Billing Display Only If Exists','Complete Do Not Require Notes','Edit Section Options','Service Limit Service Category','Hide Trash Icon','Complete Hide Sign & Complete','Finish Create Recurring Ticket','Service Staff Checklist Scroll To Accordion','Service Staff Checklist One Service Template Only','Service Staff Checklist Checked In Staff','Customer Complete Exits Ticket','Staff Anyone Can Add','Location Notes Anyone Can Add','Location Filter By Client','Attached Contact Notes Anyone Can Add','Notes Anyone Can Add','Notes Alert','Notes Email Default On','Complete Combine Checkout Summary','Service Staff Checklist Default Customer Template','Complete Email Users On Complete','Notify Anyone Can Add','Delete Button Add Note','Create Recurrence Button','External Response','External Response Thread','External Response Status','External Response Documents','Medication Multiple Days','Medication Group Days','Service Track Total Time','Service Track Direct Time','Service Track Indirect Time','Inventory General Weight Convert KG to LB','Check Out Before Check In','Staff Check Shifts','Staff Check Days Off','Staff Hide No Shift','Staff Hide Days Off'];
>>>>>>> 6cb42dba... Ocean BOL
