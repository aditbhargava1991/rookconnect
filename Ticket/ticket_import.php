...
<form class="form-horizontal margin-vertical margin-horizontal" action="" method="POST" enctype="multipart/form-data">
	...
	<?php if(count($ticket_types) > 1) { ?>
		<div class="form-group">
			<label class="col-sm-4">Import as <?= TICKET_NOUN ?> Tab:<br><i>(NOTE: All <?= TICKET_TILE ?> in this import will be imported as this <?= TICKET_NOUN ?> Tab if a <?= TICKET_NOUN ?> Tab is selected.)</i></label>
			<div class="col-sm-8">
