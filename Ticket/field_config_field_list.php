...
if(!$action_mode && !$estimate_mode && !$status_fields && !$overview_mode && !$unlock_mode && !$intake_mode) {
	...
	<div class="form-group">
		...
		<label class="form-checkbox"><input type="checkbox" <?= in_array("Set Incognito Fields", $all_config) ? 'checked disabled' : (in_array("Set Incognito Fields", $value_config) ? "checked" : '') ?> value="Set Incognito Fields" name="tickets[]">
			<span class="popover-examples"><a data-toggle="tooltip" data-original-title="If this is enabled, the user can use the Incognito Icon to disable fields so they will not display on the PDF for <?= POS_ADVANCE_TILE ?>."><img src="<?= WEBSITE_URL ?>/img/info.png" class="inline-img small"></a></span>Set Incognito Fields<img class="inline-img no-toggle" title="Incognito Field" src="../img/icons/ROOK-incognito-icon.png"></label>
		<div class="form-group">
