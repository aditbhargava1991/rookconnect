...
<div class="col-sm-12 preview_div">
    ...
    <h4 class="clearfix" <?= (in_array('promo',$field_config) ? '' : 'style="display:none;"') ?>>Promotion: <label class="detail_promo_amt pull-right"><?= $promotionid > 0 ? '' : 'N/A' ?></label></h4>
    <h4 class="clearfix" <?= (in_array('discount',$field_config) ? '' : 'style="display:none;"') ?>>Discount: <label class="detail_discount_amt pull-right">$0.00</label></h4>
    <h4 class="clearfix">Sub-Total after Discount: <label class="detail_sub_total_after_discount pull-right">$0.00</label></h4>
    <h4 class="clearfix" <?= (in_array('delivery',$field_config) ? '' : 'style="display:none;"') ?>>Delivery: <label class="detail_shipping_amt pull-right">$0.00</label></h4>
    <h4 class="clearfix" <?= (in_array('assembly',$field_config) ? '' : 'style="display:none;"') ?>>Assembly: <label class="detail_assembly_amt pull-right">$0.00</label></h4>
    <h4 class="clearfix">Total before Tax: <label class="detail_mid_total_amt pull-right">$0.00</label></h4>
    <h4 class="clearfix">GST: <label class="detail_gst_amt pull-right">$0.00</label></h4>
    <h4 class="clearfix" <?= (in_array('tips',$field_config) ? '' : 'style="display:none;"') ?>>Gratuity: <label class="detail_gratuity_amt pull-right">$0.00</label></h4>
    <h4 class="clearfix" <?= (in_array('gf',$field_config) ? '' : 'style="display:none;"') ?>>Gift Card Value: <label class="detail_gf_amt pull-right"><span id="detail_gift_amount">N/A</span></label></h4>
    <h4 class="clearfix" style="display:none;">Credit to Account: <label class="detail_credit_balance pull-right">$0.00</label></h4>
    <h4 class="clearfix">Total: <label class="detail_total_amt pull-right">$0.00</label></h4>
    <h4 class="clearfix" style="display:none;">Refund Amount: <label class="detail_refund_amt pull-right">$0.00</label></h4>
    <h4 class="clearfix" style="display:none;">Adjustment Amount: <label class="detail_adjust_amt pull-right">$0.00</label></h4>
    <h4 class="clearfix" style="display:none;"><?= count($payer_config) > 1 ? 'Third Party' : $payer_config[0] ?> Portion: <label class="detail_insurer_amt pull-right">$0.00</label></h4>
    <h4 class="clearfix" style="display:none;"><?= count($purchaser_config) > 1 ? 'Customer' : $purchaser_config[0] ?> Portion: <label class="detail_patient_amt pull-right">$0.00</label></h4>
</div>